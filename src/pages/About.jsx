...
import homeBannerImage from "../assets/img/img-source-2.png";
import Banner from "./components/Banner.jsx";

const About = () => {
    return (
        <div>
            <Banner imageSrc={homeBannerImage} />

            {/* Centrer et limiter la largeur des Collapse */}
            <div className="container mx-auto py-8 max-w-[65rem]"> {/* max-w-2xl limite la largeur */}
                <Collapse label="Fiabilité">
                    <p>Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux
                ...
                <Collapse label="Service">
                    <p>La qualité du service est au cœur de notre engagement chez Kasa. Nous veillons à ce que chaque
                        interaction, que ce soit avec nos hôtes ou nos locataires, soit empreinte de respect et de bienveillance.</p>
                </Collapse>
