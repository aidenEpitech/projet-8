...
const About = () => {
    return (
        <div>
            ...
            <div className="container mx-auto py-8 max-w-[65rem]"> {/* Conteneur centré */}
                <div className="mb-6">
                ...
                <div className="mb-6">
                    <Collapse label="Service">
                        <p>La qualité du service est au cœur de notre engagement chez Kasa. Nous veillons à ce que
                            chaque interaction, que ce soit avec nos hôtes ou nos locataires, soit empreinte de respect et de
                            bienveillance.</p>
                    </Collapse>
                </div>
                <div className="mb-6">
